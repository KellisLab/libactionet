    ...
    if (NOT LIBACTIONET_BUILD_R AND BLA_VENDOR STREQUAL "All")
        ...
        if (DEFINED ENV{MKLROOT} AND EXISTS "$ENV{MKLROOT}/include")
            ...
            if (DEFINED ENV{CONDA_PREFIX})
                list(APPEND _mkl_search_paths "$ENV{CONDA_PREFIX}/lib")
            endif()
            if (DEFINED ENV{MKLROOT})
                list(APPEND _mkl_search_paths "$ENV{MKLROOT}/lib" "$ENV{MKLROOT}/lib/intel64")
            endif()
            find_library(MKL_RT_LIBRARY NAMES mkl_rt HINTS ${_mkl_search_paths})
            if (MKL_RT_LIBRARY)
                set(_mkl_detected TRUE)
            endif()
        endif()

...
namespace actionet {
    ...
    arma::mat computeFeatureStats(arma::sp_mat& G, arma::sp_mat& S, arma::sp_mat& X, int norm_type = 2,
    ...
    arma::mat computeFeatureStatsVision(arma::sp_mat& G, arma::sp_mat& S, arma::sp_mat& X, int norm_type = 2,
                                        double alpha = 0.85, int max_it = 5, bool approx = false, int thread_no = 0);
}

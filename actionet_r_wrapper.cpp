...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List run_ACTION_muV(const Rcpp::List &S, int k_min, int k_max, arma::vec alpha, double lambda = 1, int AA_iters = 50, int Opt_iters = 0, int thread_no = 0)
{
...
{
  arma::field<arma::mat> reduction = ACTIONet::reduce_kernel(S, reduced_dim, iter, seed,
...
//' S_r = reduction.out$S_r
// [[Rcpp::export]]
Rcpp::List reduce_kernel_full(arma::mat &S, int reduced_dim = 50, int iter = 5,
...
// [[Rcpp::export]]
Rcpp::List run_ACTION(arma::mat &S_r, int k_min = 2, int k_max = 30, int thread_no = 0,
...
//' = ACTION.out$H[[8]] ' cell.assignments = apply(H8, 2, which.max)
// [[Rcpp::export]]
Rcpp::List run_ACTION_plus(arma::mat &S_r, int k_min = 2, int k_max = 30, int max_it = 100,
...
// [[Rcpp::export]]
Rcpp::List run_online_ACTION(arma::mat &S_r, arma::field<arma::uvec> samples, int k_min = 2,
...
// [[Rcpp::export]]
Rcpp::List run_weighted_ACTION(arma::mat &S_r, arma::vec w, int k_min = 2, int k_max = 30,
                      ...
                      int min_cells = 3)
{
  ...
  for (int i = 0; i < n_list; i++)
  {
    ...
    C_trace_vec[i + 1] = (as<arma::mat>(C_trace[i]));
    H_trace_vec[i + 1] = (as<arma::mat>(H_trace[i]));
  }
...
// [[Rcpp::export]]
Rcpp::List unify_archetypes(arma::mat &S_r, arma::mat C_stacked, arma::mat H_stacked,
...
//'	G = buildNetwork(prune.out$H_stacked)
// [[Rcpp::export]]
arma::sp_mat buildNetwork(arma::mat H, string algorithm = "k*nn", string distance_metric = "jsd", double density = 1.0, int thread_no = 0,
...
// [[Rcpp::export]]
arma::sp_mat build_knn(arma::mat H, string distance_metric = "jsd", double k = 10, int thread_no = 0,
                 bool mutual_edges_only = true)
{

  double M = 16, ef_construction = 200, ef = 200;

  arma::sp_mat G = ACTIONet::buildNetwork(H, "knn", distance_metric, 1, thread_no, M,
                                    ef_construction, ef, mutual_edges_only, k);
...
// [[Rcpp::export]]
Rcpp::List layoutNetwork(arma::sp_mat &G, arma::mat &initial_position,
                   ...
                   double min_dist = 1, double spread = 1, double gamma = 1.0, unsigned int n_epochs = 500, int thread_no = 0, int seed = 0, double learning_rate = 1.0, int sim2dist = 2)
{
  ...
  arma::field<arma::mat> res = ACTIONet::layoutNetwork_xmap(G, initial_position, presmooth_network, method, min_dist, spread, gamma, n_epochs, thread_no, seed, learning_rate, sim2dist);
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List autocorrelation_Geary(sp_mat G, mat scores, int normalization_method = 1, int perm_no = 30, int thread_no = 0)
{
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List autocorrelation_Geary_full(mat G, mat scores, int normalization_method = 1, int perm_no = 30, int thread_no = 0)
{
  field<vec> out = ACTIONet::autocorrelation_Geary(G, scores, normalization_method, perm_no, thread_no);
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List autocorrelation_Moran(sp_mat G, mat scores, int normalization_method = 1, int perm_no = 30, int thread_no = 0)
{
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List autocorrelation_Moran_full(mat G, mat scores, int normalization_method = 1, int perm_no = 30, int thread_no = 0)
{
  field<vec> out = ACTIONet::autocorrelation_Moran(G, scores, normalization_method, perm_no, thread_no);
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
Rcpp::List aggregate_genesets(sp_mat &G, sp_mat &S, sp_mat &marker_mat, int network_normalization_method = 0, double alpha = 0.85, int thread_no = 0)
{
  arma::field<arma::mat> stats = ACTIONet::aggregate_genesets_vision(G, S, marker_mat, network_normalization_method, alpha, thread_no);
